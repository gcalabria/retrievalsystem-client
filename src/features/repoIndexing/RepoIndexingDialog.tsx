...
export default function RepoIndexingDialog() {
  const [activeStep, setActiveStep] = useState<number>(0);
  const [isDialogOpen, setIsDialogOpen] = useState(false);
  const [form, setForm] = useState<IndexRequest>(emptyIndexRequest);
  ...
  const handleChangeExpansionmethods = (
  ...
  const handleChangeCollectionAction = (
    event: React.ChangeEvent<HTMLInputElement>,
  ) => {
    const { name, value } = event.target;
  ...
  function FormStep(step: number) {
    switch (step) {
      ...
      case 1: {
        return (
          <>
            <FormControl>
              <FormLabel sx={{ mb: 2 }}>
                Would you like to create a new collection or update an existing
                one?
              </FormLabel>
              <RadioGroup
                row
        ...
        return (
          <>
            {form.collectionAction === 'UPDATE' && (
              <FormControl>
                <FormLabel sx={{ mb: 2 }}>
                  Would you like to create a new index or update an existing
                  one?
                </FormLabel>
                <RadioGroup
                  row
        ...
        return (
          <>
            <FormControl>
              ...
              <FormGroup onChange={handleChangeExpansionmethods}>
                <FormControlLabel
                  control={
                    <Checkbox
            ...
            {form.model === COLBERT_NAME && (
              <FormControl>
                <FormLabel>How would you like to index this?</FormLabel>
                <RadioGroup
                  row
      ...
      case 4: {
        return (
          <>
            <Typography variant="h5">Indexing Summary:</Typography>
            ...
            <Typography variant="h6">Document Expansion:</Typography>
            <div>
              <b>Methods: </b>
            ...
            <>
              ...
              {activeStep === steps.length - 1 ? (
                <Box sx={{ m: 1, position: 'relative' }}>
                  <LoadingButton variant="contained" onClick={handleFinish}>
                    Submit
                  </LoadingButton>
                </Box>
              ) : (
